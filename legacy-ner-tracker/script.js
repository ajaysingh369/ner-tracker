...
function buildAthleteRow(athlete) {
    ...
    if (isDummy) {
        ...
        const BASE_URL = 'https://ner-tracker.vercel.app';
        cell.innerHTML = `<button class="authorize-btn" onclick="window.location.href='${BASE_URL}/auth/strava?state=mobile'">Authorize with Strava</button>`;
